...
\pgfsetlayers{bbackground layer,background layer,main,foreground layer}
	...
	\begin{tikzpicture}[auto, >=triangle 45]
		...
		\node [acessibles,fill = accessiblecolor!30,above = of parameters, yshift = 0.7cm,font = \large] (accs){Accessibles};
		
		\begin{pgfonlayer}{background layer}
			%\draw[-,consists] (accs) -- (mod1);
			\node [block, fill= accessiblecolor!30,thick,inner sep=1em,fit= {(accs)(param_properties)(cmd_properties) (commands) (parameters)}] (accs_block) {};
		\end{pgfonlayer}
		...
		\begin{pgfonlayer}{bbackground layer}
			\node [block,draw = black,fill = black!5,thick,inner sep=2em,fit = {(accs_block)(mod_properties)(node_properties)(nodes)(modules)}]	(all){};
		\end{pgfonlayer}	
