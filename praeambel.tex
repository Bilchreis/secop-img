...
% SECoP Classes
\definecolor{ecscolor}{HTML}{614E31}
\definecolor{nodecolor}{HTML}{00C7E0}
\definecolor{modulecolor}{HTML}{305B61}
\definecolor{accessiblecolor}{HTML}{E03A00}
\definecolor{properycolor}{HTML}{E08700}

% SECoP Protocol Message
\definecolor{SECoPProtocol}{HTML}{304C65}




\newcommand{\propcol}{properycolor!30}
\newcommand{\nodecol}{nodecolor!40}
\newcommand{\modcol}{modulecolor!50}
\newcommand{\accesscol}{accessiblecolor!50}
