...
% SECoP Classes
\definecolor{ecscolor}{HTML}{FED45B}
\definecolor{nodecolor}{HTML}{1BB28C}
\definecolor{modulecolor}{HTML}{8E5A53}
\definecolor{accessiblecolor}{HTML}{9BC7C5}
\definecolor{properycolor}{HTML}{D6D5D2}

% SECoP Protocol Message
\definecolor{SECoPProtocol}{HTML}{E86A58}


\newcommand{\propcol}{properycolor}
\newcommand{\nodecol}{nodecolor!40}
