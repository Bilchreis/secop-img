...
\begin{document}
	\begin{tikzpicture}
		...
		node[active,fill = \ecsscol,below = of node,minimum height = 4cm, yshift = -1cm] (activate){}
		...
		\p1= (node.south), 
		\p2= (ecs.south) in
		([yshift = -6.5cm]\p1) -- node [messtext]{update t1:value [295.14,\{"t":1505396349.259845\}]}([yshift = -6.5cm]\x2,\y2 - 0.5cm);
		...
		\p1= (node.south), 
		\p2= (ecs.south) in
		([yshift = -8cm]\p1) -- node [messtext]{update t1:value [295.13,\{"t":1505396350.324752\}]}([yshift = -8cm]\x2,\y2 - 0.5cm);
